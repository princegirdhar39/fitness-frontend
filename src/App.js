    ...
    <div className="container-1">
      <div className="container-2">
        ...
        <div className="addUser">
          <div className="popup-div">
            <Popup trigger={<button className="blue"> Add+</button>} position="right center">
              <div>
                <form>
                  <label>
                    First_name:
                ...
                <button
                  type="submit"
                  className="blue"
                  onClick={() => createNewUser(firstName, lastName, email)}
                >
                  Add
                </button>
              </div>
      ...
      <div className="container-3">
        ...
        <div className="container-7">
              ...
              <div className="list-container">
                ...
                <div className="list">
                  {selectedUser.prescriptions.map((p) => (
                    <div className="list-item">{p.prescription}</div>
                  ))}
                  {selectedUser.prescriptions.map((p) => (
                    <div className="list-item">{p.prescription}</div>
                  ))}
              ...
              <div className="list-container">
                ...
                <div className="list">
                  {selectedUser.conditions.map((condition) => {
                    return (
                      <div className="list-item ">{condition.condition}</div>
                    );
                  })}
                  {selectedUser.conditions.map((condition) => {
                    return (
          ...
          {selectedUser && <div className="notes">
